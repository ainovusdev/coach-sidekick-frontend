        ...
        <CardContent className={compact ? 'pt-0' : ''}>
          <p className="text-xs text-gray-500">
            {compact
              ...
              : 'No similar sessions found yet. Continue the conversation to build history.'}
          </p>
        </CardContent>
      </Card>
    )
    ...
    <Card className={compact ? 'h-auto' : 'h-full'}>
      <CardHeader className={compact ? 'pb-2 py-2' : 'pb-3'}>
        ...
        >
          ...
          />
          {compact
            ? `Similar (${sessions.length})`
            : `Similar Past Sessions (${sessions.length})`}
        </h3>
      </CardHeader>
        ...
        {displaySessions.map((session, index) => {
          ...
          return (
            <div
              ...
              className={
                compact
                  ? 'border rounded p-2 hover:bg-gray-50 transition-colors'
            ...
            >
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge
                      className={`text-xs ${getCertaintyColor(session.certainty)}`}
                    >
                  ...
                  {session.sentiment && (
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-600">
                        Sentiment:{' '}
                        <span className="font-medium">{session.sentiment}</span>
                      </span>
                    </div>
                  )}
                </div>
