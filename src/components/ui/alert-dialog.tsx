...
/**
 * Modal confirmation dialog for blocking decisions, built on Radix AlertDialog.
 * Compose with AlertDialogTrigger, AlertDialogContent, AlertDialogHeader/Footer,
