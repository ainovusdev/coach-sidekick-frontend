...
export function ClientCard({ name, notes, onClick, className, clientId: _clientId }: ClientCardProps) {
          ...
          <CardContent className="p-3">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-gray-500 text-sm">Restricted Access</p>
                <p className="text-xs text-gray-400">Viewer permissions required</p>
              </div>
            </div>
          </CardContent>
        </Card>
