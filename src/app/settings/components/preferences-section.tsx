    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Describe your coaching style, methodology, and preferences. This
            will help AI provide suggestions aligned with your approach.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="bg-muted/50 p-4 rounded-lg space-y-3">
            ...
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              <li>
                Your primary coaching methodology (GO LIVE, GROW, Co-Active,
                etc.)
              </li>
              <li>
                Your coaching style (directive, facilitative, transformational,
                etc.)
              </li>
              <li>Types of questions you prefer to ask</li>
              <li>
                Areas you focus on most (leadership, career, personal growth,
                etc.)
              </li>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-medium">
              Example Preference Descriptions:
            </h3>
