    ...
    <div className="space-y-3 mb-6">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative">
          <Search className="absolute left-2.5 top-1/2 -translate-y-1/2 h-4 w-4 text-ink-4 pointer-events-none" />
          <Input
            value={searchInput}
            onChange={e => onSearchChange(e.target.value)}
            placeholder="Search commitments..."
            className="pl-8 w-[220px] border-line"
          />
          {searchInput && (
            <button
        ...
        >
          <SelectTrigger className="w-[150px] border-line ">
            <span className="flex items-center gap-1.5 truncate">
              <ArrowUpDown className="h-3.5 w-3.5 text-ink-4 shrink-0" />
              <SelectValue />
            </span>
          </SelectTrigger>
          <SelectContent>
        ...
        >
          <SelectTrigger className="w-[160px] border-line ">
            <span className="flex items-center gap-1.5 truncate">
              <Layers className="h-3.5 w-3.5 text-ink-4 shrink-0" />
              <SelectValue />
            </span>
          </SelectTrigger>
          <SelectContent>
