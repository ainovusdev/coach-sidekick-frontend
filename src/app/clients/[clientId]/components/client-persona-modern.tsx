      ...
      <div className="text-center py-16">
        <div className="max-w-md mx-auto">
          <div className="p-6 bg-gray-50 rounded-2xl">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">Building Client Persona</h3>
            <p className="text-gray-600">The AI is learning about your client. Persona insights will appear here after analyzing coaching sessions.</p>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-4 text-white">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-2xl font-bold">{persona.metadata.sessions_analyzed}</span>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-2xl font-bold text-gray-900">{confidencePercentage.toFixed(0)}%</span>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-lg font-bold text-gray-900">
              {persona.patterns.strengths.length + persona.progress.achievements.length}
            </span>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-lg font-bold text-gray-900">
              {persona.goals.primary_goals.length + persona.goals.short_term_goals.length}
            </span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900 capitalize">{persona.demographics.occupation}</p>
                    </div>
                  </div>
                </div>
              )}
                ...
                {persona.goals.primary_goals.map((goal, index) => (
                  <div key={index} className="group relative">
                    ...
                    <div className="relative p-4 flex items-start gap-3">
                      ...
                      <p className="text-sm font-medium text-gray-900 leading-relaxed">{goal}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <CardContent>
              ...
              {persona.personality.communication_style && (
                <div className="mt-4 p-3 bg-gray-50 rounded-lg text-center">
                  ...
                  <p className="text-sm font-semibold text-gray-900 capitalize">{persona.personality.communication_style}</p>
                </div>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 lg:col-span-2">
            ...
            <CardContent>
              <div className="space-y-2">
                {persona.challenges.main_challenges.slice(0, 3).map((challenge, index) => (
                  <div key={index} className="flex items-start gap-3 p-3 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200">
                    <div className="p-1.5 bg-gray-100 rounded">
                      <AlertCircle className="h-3.5 w-3.5 text-gray-600" />
                    </div>
                    <p className="text-sm text-gray-700 flex-1">{challenge}</p>
                  </div>
                ))}
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="grid grid-cols-2 gap-2">
                {persona.personality.values.map((value, index) => (
                  <div key={index} className="p-3 bg-gray-900 text-white rounded-lg text-center">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {persona.patterns.strengths.map((strength, index) => (
                  <div key={index} className="flex items-center gap-3 p-3 bg-gradient-to-r from-gray-50 to-white rounded-lg border border-gray-200">
            ...
            <CardContent>
              <div className="space-y-2">
                {persona.patterns.growth_areas.map((area, index) => (
                  <div key={index} className="p-3 border-l-2 border-gray-400 bg-gray-50 rounded-r-lg">
        ...
        {(persona.progress.achievements.length > 0 || persona.progress.breakthrough_moments.length > 0) && (
          <Card className="border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 lg:col-span-3">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-semibold text-gray-900 flex items-center gap-2">
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {persona.progress.breakthrough_moments.length > 0 && (
                  <div>
                    <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-3">Breakthrough Moments</h4>
                    <div className="space-y-2">
                      {persona.progress.breakthrough_moments.map((moment, index) => (
                        <div key={index} className="p-3 bg-gray-900 text-white rounded-lg">
              ...
              <div className="flex flex-wrap gap-2">
                {persona.patterns.recurring_themes.map((theme, index) => (
                  <Badge
                    ...
                    className={cn(
                      "px-3 py-1.5",
                      index < 2 ? "bg-gray-900 text-white border-gray-900" :
                      index < 4 ? "bg-gray-200 text-gray-800 border-gray-200" :
        ...
        {(persona.challenges.fears.length > 0 || persona.challenges.obstacles.length > 0) && (
          <Card className="border-gray-200 shadow-sm hover:shadow-lg transition-all duration-300 lg:col-span-3">
            <CardHeader className="pb-3">
              <CardTitle className="text-sm font-semibold text-gray-900 flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {persona.challenges.fears.map((fear, index) => (
                        <div key={index} className="p-3 bg-gray-50 rounded-lg border-l-2 border-gray-400">
